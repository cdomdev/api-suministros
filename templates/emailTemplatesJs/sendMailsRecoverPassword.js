...
export function sendMailsRecover(nombre, email, ruta) {
  ...
  const notificaciones = [
    ...
    // Notificacion para usuario
    {
      ...
      titulo: `¡Hola ${nombre}! `,
      route: ruta,
      text: `Si no solicitaste este cambio, puedes ignorar este correo electrónico.`,
    },
    // Correo programado
    {
    ...
    <div class="container" style="width: 100%; background-color: #e3e3e3;">
        <div style=" padding: 20px 10px;">
            ...
            gap: 10px; background-color: white;">
                ...
                <h2 style="font-size: 20px; margin: 0px 0px 1em 0px;">¡Hola ${nombre}! </h2>
                <hr style="width: 95%; margin: auto;">
                <p style="font-size: 14px; margin: 10px 0em 2em 0em; text-wrap: wrap; line-height: 19px;">Hemos recibido
                    una solicitud para cambiar tu contraseña.
                    Para hacerlo, haz clic en el siguiente enlace. <br>
                    El enlace solo será válido por veinticuatro horas, Si no solicitaste este cambio, puedes ignorar
                    este correo electrónico<br />
                </p>


                <!-- Botón  para restablcer contraseña -->

                <a href="${ruta}" class="btn-recover" style="width: 10%;
                align-self: center;
                ...
                font-size: 15px;
                list-style: none;
                border-radius: 5px;">Restablcer tu contreseña</a>
